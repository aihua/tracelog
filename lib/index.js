...
(function (tracelog) {
    ...
    function log(opt) {
        var defaultopt = { depth: 3, color: 'yellow', printfullstack: false, disable: false, useMockjs: false, callback: undefined, printJSON: false };
        if (opt == null) {
            opt = defaultopt;
        }
        else {
        ...
        return function (sth, expect, tmpopt) {
            ...
            if (options('useMockjs')) {
                compare2Objects = function (sth, expect) {
